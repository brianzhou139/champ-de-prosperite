...
import { JOB_TYPE_CREATE_ACC_EMAIL_PASS } from '@utils/constants/job_constants';
import { JOB_TYPE_ACC_GOOGLE_AUTH } from '@utils/constants/job_constants';
import { JOB_TYPE_SIGNIN_EMAIL_PASS } from '@utils/constants/job_constants';
...
export const ObserverDbUSersState = async (useruid:any,tempDbUser:any,callback:any) => {
  initFirebase();
  const db = getDatabase();
  const dbRef = ref(db, 'dbusers/'+useruid);
