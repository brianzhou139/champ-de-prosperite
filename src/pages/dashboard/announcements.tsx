...
import { ANNOUNCEMENT } from '@models/db_model';
...
export default function Announcements() {
  ...
  const initialAnnouncementList = useRef<ANNOUNCEMENT[]>([]);
     ...
     (async () => {
         if(true){
             ...
             onValue(orderedRef, (snapshot) => {
               ...
               if (JSON.stringify(tempList) !== JSON.stringify(initialAnnouncementList.current)) {
                setAnnouncementList(tempList);
                initialAnnouncementList.current = tempList;
               }
  ...
  const handlePostButtonClick=()=>{
    ...
    postObjectData(db_path, newAnnouncement,receiverRealTimeDbResults);
  ...
  const handleOnDelete=(item:ANNOUNCEMENT)=>{
    if(dbuser==null){
      return;
    }
  ...
  const sendNotificationAgain=(item:ANNOUNCEMENT)=>{
    if(dbuser==null){
      return;
    }
    ...
    <Layout>
      ...
      <main className="">
          ...
          <div className='rounded mx-5 mt-3'>
            ...
            {/**  View Data */}
            {tabNumber===1 && announcementList.length>0 && (
              <div className=''>
                {/* Table Here */}
              ...
              <div className='h-[400px] flex items-center justify-center'>
                <div className='mt-10 flex flex-col items-center justify-center'>
                  <div className='font-medium'>
                    You haven't posted An Announcement yet
                  </div>
                  <div>
